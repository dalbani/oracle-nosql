...
public class ArbNodeService
    ...
    public void initialize(SecurityParams securityParams,
        ...
        arbStatsTracker =
            new ArbStatsTracker(this, params.getArbNodeParams().getMap(),
                                monitorBuffer);
        addParameterListener(arbStatsTracker);
    ...
    public void start() {
        ...
        try {
            ...
            /*
             * Start up admin.  Most requests will fail until the arbNode is
             * started but this is done early to allow ping() to function.
             */
            admin.startup();

            /*
             * Start up the arbNode so that it's available for admin and user
             * requests.
             */
            arbNode.startup();
