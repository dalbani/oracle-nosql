 ...
 */
abstract class InternalOperationHandler<T extends InternalOperation> {
     ...
     * <p>
     * The {@link #getVersion(Cursor, OperationResult) access via cursor} for
     * version data is skipped for performance reason unless required by the
     * given return choice.
     * <p>
     ...
     *
     * Both 0 and 1 need to be accepted. See Value.writeFastExternal() where it
     * is writing with Format of NONE or TABLE.
     */
