...
public class OnqlShell extends CommonShell {
    ...
    static String RC_FILE_SECTION = "onql";
    static OutputMode QUERY_OUTPUT_MODE_DEF = OutputMode.COLUMN;
    ...
    static final String prompt = "onql-> ";
    static final String usageHeader = "Oracle NoSQL ONQL Shell commands:" + eol;
    ...
    public OnqlShell(InputStream input, PrintStream output) {
        super(input, output, true /* disableJlineEventDesignator */);
    ...
    public static class OutputModeCommand extends ShellCommand {
        ...
        static {
            final StringBuilder sb = new StringBuilder();
            final String[] modes = {MODE_COLUMN, MODE_LINE,
                                    MODE_JSON, MODE_CSV};
