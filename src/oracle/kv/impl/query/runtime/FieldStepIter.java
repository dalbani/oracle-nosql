...
public class FieldStepIter extends PlanIter {
    ...
    public boolean next(RuntimeControlBlock rcb) {
        ...
        /*
         * theFieldPos is > 0 when the field name is known at compile time,
         * the input expr is also known at compile time to return records
         * of known type, and the input iterator returns its results as a
         * tuple. In this case there is nothing to do: The result has already
         * been stored in a register R by the input iter and theResultReg of
         * this iter points to R.
         */
        if (theFieldPos >= 0) {
        ...
        while (true) {
            ...
            /*
             * We have a candidate ctx item. If is an array, stack the
            ...
            if (ctxItemKind == Type.RECORD) {
                ...
                if (ctxItem.isTuple()) {
                    ...
                    result = (FieldValueImpl)rec.get(state.theFieldName);
                }
                ...
                result = (FieldValueImpl)map.get(state.theFieldName);
