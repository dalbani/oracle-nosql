...
public class ServerTableIter extends BaseTableIter {
    ...
    private ServerTableIter(
        ...
        super(loc, statePos, resultReg, tupleRegs,
              ...
              usesCoveringIndex, pushedExternals);
    ...
    public boolean next(RuntimeControlBlock rcb) {
        ...
        TableScannerFactory.TableScanner scanner = state.getScanner();
        ...
        if (theFilterIter != null || theUsesCoveringIndex) {
            ...
            while (row != null) {
                ...
                for (String s : row.getFields()) {
                    rcb.setRegVal(theTupleRegs[i++], (FieldValueImpl)row.get(s));
                }
                ...
                if (theFilterIter != null) {
                    ...
                    if (match) {
                        FieldValueImpl val =
                            rcb.getRegVal(theFilterIter.getResultReg());
    ...
    /**
     * An instance of ServerIterFactory is created during TableQuery.execute()
     * and is stored in the RCB.
     */
